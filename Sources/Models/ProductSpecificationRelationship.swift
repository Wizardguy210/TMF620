...
public class ProductSpecificationRelationship: APIModel {
    ...
    public init(alphabaseType: String? = nil, alphareferredType: String? = nil, alphaschemaLocation: URL? = nil, alphatype: String? = nil, href: URL? = nil, id: String? = nil, name: String? = nil, relationshipType: String? = nil, validFor: TimePeriod? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductSpecificationRelationship else { return false }
    ...
    public static func == (lhs: ProductSpecificationRelationship, rhs: ProductSpecificationRelationship) -> Bool {
