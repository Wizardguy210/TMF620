...
public class ProductOfferingPriceAttributeValueChangeEvent: APIModel {
    ...
    public var event: ProductOfferingPriceAttributeValueChangeEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: ProductOfferingPriceAttributeValueChangeEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, fieldPath: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        fieldPath = try container.decodeIfPresent("fieldPath")
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingPriceAttributeValueChangeEvent else { return false }
      ...
      guard self.fieldPath == object.fieldPath else { return false }
    ...
    public static func == (lhs: ProductOfferingPriceAttributeValueChangeEvent, rhs: ProductOfferingPriceAttributeValueChangeEvent) -> Bool {
