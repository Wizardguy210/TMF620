...
public class CategoryCreateEvent: APIModel {
    ...
    public var event: CategoryCreateEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: CategoryCreateEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CategoryCreateEvent else { return false }
    ...
    public static func == (lhs: CategoryCreateEvent, rhs: CategoryCreateEvent) -> Bool {
