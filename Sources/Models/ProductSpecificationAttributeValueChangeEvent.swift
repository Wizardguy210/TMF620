...
public class ProductSpecificationAttributeValueChangeEvent: APIModel {
    ...
    public var event: ProductSpecificationAttributeValueChangeEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: ProductSpecificationAttributeValueChangeEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, fieldPath: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductSpecificationAttributeValueChangeEvent else { return false }
    ...
    public static func == (lhs: ProductSpecificationAttributeValueChangeEvent, rhs: ProductSpecificationAttributeValueChangeEvent) -> Bool {
