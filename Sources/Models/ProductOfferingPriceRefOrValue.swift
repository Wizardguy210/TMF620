...
public class ProductOfferingPriceRefOrValue: APIModel {
...
Could be month, week... */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingPriceRefOrValue else { return false }
    ...
    public static func == (lhs: ProductOfferingPriceRefOrValue, rhs: ProductOfferingPriceRefOrValue) -> Bool {
