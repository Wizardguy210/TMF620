...
public class ProductOfferingPriceStateChangeEvent: APIModel {
    ...
    public var event: ProductOfferingPriceStateChangeEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: ProductOfferingPriceStateChangeEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingPriceStateChangeEvent else { return false }
    ...
    public static func == (lhs: ProductOfferingPriceStateChangeEvent, rhs: ProductOfferingPriceStateChangeEvent) -> Bool {
