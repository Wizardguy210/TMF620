...
public class ProductOfferingStateChangeEvent: APIModel {
    ...
    public var event: ProductOfferingStateChangeEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: ProductOfferingStateChangeEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingStateChangeEvent else { return false }
    ...
    public static func == (lhs: ProductOfferingStateChangeEvent, rhs: ProductOfferingStateChangeEvent) -> Bool {
