...
public class ProductOfferingPriceRef: APIModel {
    ...
    public init(id: String, alphabaseType: String? = nil, alphareferredType: String? = nil, alphaschemaLocation: URL? = nil, alphatype: String? = nil, href: URL? = nil, name: String? = nil) {
        self.id = id
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingPriceRef else { return false }
    ...
    public static func == (lhs: ProductOfferingPriceRef, rhs: ProductOfferingPriceRef) -> Bool {
