...
public class Attachment: APIModel {
    ...
    public init(alphabaseType: String? = nil, alphaschemaLocation: URL? = nil, alphatype: String? = nil, attachmentType: String? = nil, content: String? = nil, description: String? = nil, href: URL? = nil, id: String? = nil, mimeType: String? = nil, name: String? = nil, size: Quantity? = nil, url: URL? = nil, validFor: TimePeriod? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? Attachment else { return false }
