...
public class CatalogStateChangeEvent: APIModel {
    ...
    public var event: CatalogStateChangeEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: CatalogStateChangeEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CatalogStateChangeEvent else { return false }
    ...
    public static func == (lhs: CatalogStateChangeEvent, rhs: CatalogStateChangeEvent) -> Bool {
