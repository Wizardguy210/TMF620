...
public class ProductOfferingStateChangeEventPayload: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingStateChangeEventPayload else { return false }
      guard self.productOffering == object.productOffering else { return false }
      return true
    }

    public static func == (lhs: ProductOfferingStateChangeEventPayload, rhs: ProductOfferingStateChangeEventPayload) -> Bool {
