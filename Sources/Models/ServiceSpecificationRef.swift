...
public class ServiceSpecificationRef: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ServiceSpecificationRef else { return false }
    ...
    public static func == (lhs: ServiceSpecificationRef, rhs: ServiceSpecificationRef) -> Bool {
