...
public class CatalogAttributeValueChangeEvent: APIModel {
    ...
    public var event: CatalogAttributeValueChangeEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: CatalogAttributeValueChangeEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, fieldPath: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CatalogAttributeValueChangeEvent else { return false }
    ...
    public static func == (lhs: CatalogAttributeValueChangeEvent, rhs: CatalogAttributeValueChangeEvent) -> Bool {
