...
public class ProductOfferingPriceDeleteEvent: APIModel {
    ...
    public var event: ProductOfferingPriceDeleteEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: ProductOfferingPriceDeleteEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingPriceDeleteEvent else { return false }
    ...
    public static func == (lhs: ProductOfferingPriceDeleteEvent, rhs: ProductOfferingPriceDeleteEvent) -> Bool {
