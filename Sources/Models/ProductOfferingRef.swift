...
public class ProductOfferingRef: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingRef else { return false }
    ...
    public static func == (lhs: ProductOfferingRef, rhs: ProductOfferingRef) -> Bool {
