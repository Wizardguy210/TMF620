...
public class ResourceSpecificationRef: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ResourceSpecificationRef else { return false }
    ...
    public static func == (lhs: ResourceSpecificationRef, rhs: ResourceSpecificationRef) -> Bool {
