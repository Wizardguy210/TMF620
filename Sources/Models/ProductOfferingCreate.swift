...
public class ProductOfferingCreate: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingCreate else { return false }
    ...
    public static func == (lhs: ProductOfferingCreate, rhs: ProductOfferingCreate) -> Bool {
