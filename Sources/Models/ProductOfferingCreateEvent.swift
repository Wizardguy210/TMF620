...
public class ProductOfferingCreateEvent: APIModel {
    ...
    public var event: ProductOfferingCreateEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: ProductOfferingCreateEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingCreateEvent else { return false }
    ...
    public static func == (lhs: ProductOfferingCreateEvent, rhs: ProductOfferingCreateEvent) -> Bool {
