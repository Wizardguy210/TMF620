...
public class ProductOffering: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOffering else { return false }
    ...
    public static func == (lhs: ProductOffering, rhs: ProductOffering) -> Bool {
