...
public class ProductOfferingPriceUpdate: APIModel {
...
Could be month, week... */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingPriceUpdate else { return false }
    ...
    public static func == (lhs: ProductOfferingPriceUpdate, rhs: ProductOfferingPriceUpdate) -> Bool {
