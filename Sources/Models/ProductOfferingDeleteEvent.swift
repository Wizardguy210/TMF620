...
public class ProductOfferingDeleteEvent: APIModel {
    ...
    public var event: ProductOfferingDeleteEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: ProductOfferingDeleteEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingDeleteEvent else { return false }
    ...
    public static func == (lhs: ProductOfferingDeleteEvent, rhs: ProductOfferingDeleteEvent) -> Bool {
