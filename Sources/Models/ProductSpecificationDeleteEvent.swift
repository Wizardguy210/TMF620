...
public class ProductSpecificationDeleteEvent: APIModel {
    ...
    public var event: ProductSpecificationDeleteEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: ProductSpecificationDeleteEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductSpecificationDeleteEvent else { return false }
    ...
    public static func == (lhs: ProductSpecificationDeleteEvent, rhs: ProductSpecificationDeleteEvent) -> Bool {
