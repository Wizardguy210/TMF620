...
public class CatalogBatchEvent: APIModel {
    ...
    public var event: CatalogBatchEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: CatalogBatchEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CatalogBatchEvent else { return false }
    ...
    public static func == (lhs: CatalogBatchEvent, rhs: CatalogBatchEvent) -> Bool {
