...
public class CategoryStateChangeEvent: APIModel {
    ...
    public var event: CategoryStateChangeEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: CategoryStateChangeEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CategoryStateChangeEvent else { return false }
    ...
    public static func == (lhs: CategoryStateChangeEvent, rhs: CategoryStateChangeEvent) -> Bool {
