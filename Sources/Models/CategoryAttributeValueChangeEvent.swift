...
public class CategoryAttributeValueChangeEvent: APIModel {
    ...
    public var event: CategoryAttributeValueChangeEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: CategoryAttributeValueChangeEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, fieldPath: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CategoryAttributeValueChangeEvent else { return false }
    ...
    public static func == (lhs: CategoryAttributeValueChangeEvent, rhs: CategoryAttributeValueChangeEvent) -> Bool {
