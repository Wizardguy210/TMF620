...
public class ProductOfferingPriceCreateEventPayload: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingPriceCreateEventPayload else { return false }
      guard self.productOfferingPrice == object.productOfferingPrice else { return false }
      return true
    }

    public static func == (lhs: ProductOfferingPriceCreateEventPayload, rhs: ProductOfferingPriceCreateEventPayload) -> Bool {
