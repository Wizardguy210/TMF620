...
public class ProductOfferingPriceCreate: APIModel {
...
Could be month, week... */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingPriceCreate else { return false }
    ...
    public static func == (lhs: ProductOfferingPriceCreate, rhs: ProductOfferingPriceCreate) -> Bool {
