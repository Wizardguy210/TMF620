...
public class ProductOfferingAttributeValueChangeEventPayload: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingAttributeValueChangeEventPayload else { return false }
      guard self.productOffering == object.productOffering else { return false }
      return true
    }

    public static func == (lhs: ProductOfferingAttributeValueChangeEventPayload, rhs: ProductOfferingAttributeValueChangeEventPayload) -> Bool {
