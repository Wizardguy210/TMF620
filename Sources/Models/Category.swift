...
public class Category: APIModel {
    ...
    public init(alphabaseType: String? = nil, alphaschemaLocation: URL? = nil, alphatype: String? = nil, description: String? = nil, href: String? = nil, id: String? = nil, isRoot: Bool? = nil, lastUpdate: DateTime? = nil, lifecycleStatus: String? = nil, name: String? = nil, parentId: String? = nil, productOffering: [ProductOfferingRef]? = nil, subCategory: [CategoryRef]? = nil, validFor: TimePeriod? = nil, version: String? = nil) {
