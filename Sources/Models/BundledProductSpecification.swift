...
public class BundledProductSpecification: APIModel {
    ...
    public init(alphabaseType: String? = nil, alphaschemaLocation: URL? = nil, alphatype: String? = nil, href: String? = nil, id: String? = nil, lifecycleStatus: String? = nil, name: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? BundledProductSpecification else { return false }
    ...
    public static func == (lhs: BundledProductSpecification, rhs: BundledProductSpecification) -> Bool {
