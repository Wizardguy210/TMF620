...
public class ExportJobCreate: APIModel {
    ...
    public init(url: URL, alphabaseType: String? = nil, alphaschemaLocation: URL? = nil, alphatype: String? = nil, completionDate: DateTime? = nil, contentType: String? = nil, creationDate: DateTime? = nil, errorLog: String? = nil, path: String? = nil, query: String? = nil, status: JobStateType? = nil) {
        self.url = url
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ExportJobCreate else { return false }
    ...
    public static func == (lhs: ExportJobCreate, rhs: ExportJobCreate) -> Bool {
