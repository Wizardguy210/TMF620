...
public class ProductOfferingPriceRelationship: APIModel {
    ...
    public init(alphabaseType: String? = nil, alphareferredType: String? = nil, alphaschemaLocation: URL? = nil, alphatype: String? = nil, href: URL? = nil, id: String? = nil, name: String? = nil, relationshipType: String? = nil, role: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingPriceRelationship else { return false }
    ...
    public static func == (lhs: ProductOfferingPriceRelationship, rhs: ProductOfferingPriceRelationship) -> Bool {
