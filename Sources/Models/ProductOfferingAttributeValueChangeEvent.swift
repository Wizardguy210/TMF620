...
public class ProductOfferingAttributeValueChangeEvent: APIModel {
    ...
    public var event: ProductOfferingAttributeValueChangeEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: ProductOfferingAttributeValueChangeEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, fieldPath: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingAttributeValueChangeEvent else { return false }
    ...
    public static func == (lhs: ProductOfferingAttributeValueChangeEvent, rhs: ProductOfferingAttributeValueChangeEvent) -> Bool {
