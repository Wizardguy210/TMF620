...
public class CategoryDeleteEvent: APIModel {
    ...
    public var event: CategoryDeleteEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: CategoryDeleteEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CategoryDeleteEvent else { return false }
    ...
    public static func == (lhs: CategoryDeleteEvent, rhs: CategoryDeleteEvent) -> Bool {
