...
public class CatalogDeleteEvent: APIModel {
    ...
    public var event: CatalogDeleteEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: CatalogDeleteEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CatalogDeleteEvent else { return false }
    ...
    public static func == (lhs: CatalogDeleteEvent, rhs: CatalogDeleteEvent) -> Bool {
