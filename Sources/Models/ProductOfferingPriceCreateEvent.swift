...
public class ProductOfferingPriceCreateEvent: APIModel {
    ...
    public var event: ProductOfferingPriceCreateEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: ProductOfferingPriceCreateEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductOfferingPriceCreateEvent else { return false }
    ...
    public static func == (lhs: ProductOfferingPriceCreateEvent, rhs: ProductOfferingPriceCreateEvent) -> Bool {
