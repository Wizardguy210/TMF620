...
public class CatalogCreateEvent: APIModel {
    ...
    public var event: CatalogCreateEventPayload?
    ...
    public init(correlationId: String? = nil, description: String? = nil, domain: String? = nil, event: CatalogCreateEventPayload? = nil, eventId: String? = nil, eventTime: DateTime? = nil, eventType: String? = nil, priority: String? = nil, timeOcurred: DateTime? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CatalogCreateEvent else { return false }
    ...
    public static func == (lhs: CatalogCreateEvent, rhs: CatalogCreateEvent) -> Bool {
