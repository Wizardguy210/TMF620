...
public class ProductSpecificationCreate: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ProductSpecificationCreate else { return false }
    ...
    public static func == (lhs: ProductSpecificationCreate, rhs: ProductSpecificationCreate) -> Bool {
