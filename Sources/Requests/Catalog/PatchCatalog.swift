...
extension TMF620.Catalog {
    ...
    */
    public enum PatchCatalog {

        public static let service = APIService<Response>(id: "patchCatalog", tag: "catalog", method: "PATCH", path: "/catalog/{id}", hasBody: true, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PatchCatalog.service)
            }
