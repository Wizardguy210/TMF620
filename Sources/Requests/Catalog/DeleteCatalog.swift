...
extension TMF620.Catalog {
    ...
    */
    public enum DeleteCatalog {

        public static let service = APIService<Response>(id: "deleteCatalog", tag: "catalog", method: "DELETE", path: "/catalog/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteCatalog.service)
            }
