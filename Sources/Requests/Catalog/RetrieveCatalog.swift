...
extension TMF620.Catalog {
    ...
    */
    public enum RetrieveCatalog {

        public static let service = APIService<Response>(id: "retrieveCatalog", tag: "catalog", method: "GET", path: "/catalog/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RetrieveCatalog.service)
            }
