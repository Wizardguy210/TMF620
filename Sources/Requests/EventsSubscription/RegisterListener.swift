...
extension TMF620.EventsSubscription {
    ...
    */
    public enum RegisterListener {

        public static let service = APIService<Response>(id: "registerListener", tag: "events subscription", method: "POST", path: "/hub", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: RegisterListener.service)
            }
        }
