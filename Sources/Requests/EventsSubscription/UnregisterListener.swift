...
extension TMF620.EventsSubscription {
    ...
    */
    public enum UnregisterListener {

        public static let service = APIService<Response>(id: "unregisterListener", tag: "events subscription", method: "DELETE", path: "/hub/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UnregisterListener.service)
            }
