...
extension TMF620.ProductOfferingPrice {
    ...
    */
    public enum CreateProductOfferingPrice {

        public static let service = APIService<Response>(id: "createProductOfferingPrice", tag: "productOfferingPrice", method: "POST", path: "/productOfferingPrice", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: CreateProductOfferingPrice.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Created */
            case status201(ProductOfferingPrice)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ProductOfferingPrice.self, from: data))
