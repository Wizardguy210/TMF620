...
extension TMF620.ProductOfferingPrice {
    ...
    */
    public enum DeleteProductOfferingPrice {

        public static let service = APIService<Response>(id: "deleteProductOfferingPrice", tag: "productOfferingPrice", method: "DELETE", path: "/productOfferingPrice/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteProductOfferingPrice.service)
            }
