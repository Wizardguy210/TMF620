...
extension TMF620.ProductOfferingPrice {
    ...
    */
    public enum PatchProductOfferingPrice {

        public static let service = APIService<Response>(id: "patchProductOfferingPrice", tag: "productOfferingPrice", method: "PATCH", path: "/productOfferingPrice/{id}", hasBody: true, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PatchProductOfferingPrice.service)
            }
