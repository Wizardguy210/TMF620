...
extension TMF620.ProductOfferingPrice {
    ...
    */
    public enum ListProductOfferingPrice {

        public static let service = APIService<Response>(id: "listProductOfferingPrice", tag: "productOfferingPrice", method: "GET", path: "/productOfferingPrice", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ListProductOfferingPrice.service)
            }
