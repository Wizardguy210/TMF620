...
extension TMF620.ExportJob {
    ...
    */
    public enum ListExportJob {

        public static let service = APIService<Response>(id: "listExportJob", tag: "exportJob", method: "GET", path: "/exportJob", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ListExportJob.service)
            }
