...
extension TMF620.ExportJob {
    ...
    */
    public enum RetrieveExportJob {

        public static let service = APIService<Response>(id: "retrieveExportJob", tag: "exportJob", method: "GET", path: "/exportJob/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RetrieveExportJob.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ExportJob

            /** Success */
            case status200(ExportJob)
            ...
            public var responseResult: APIResponseResult<ExportJob, ErrorType> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ExportJob.self, from: data))
