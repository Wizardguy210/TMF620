...
extension TMF620.ExportJob {
    ...
    */
    public enum DeleteExportJob {

        public static let service = APIService<Response>(id: "deleteExportJob", tag: "exportJob", method: "DELETE", path: "/exportJob/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteExportJob.service)
            }
