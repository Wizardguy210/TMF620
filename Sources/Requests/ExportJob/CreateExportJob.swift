...
extension TMF620.ExportJob {
    ...
    */
    public enum CreateExportJob {

        public static let service = APIService<Response>(id: "createExportJob", tag: "exportJob", method: "POST", path: "/exportJob", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: CreateExportJob.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ExportJob.self, from: data))
