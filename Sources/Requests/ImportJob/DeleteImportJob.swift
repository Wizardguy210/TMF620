...
extension TMF620.ImportJob {
    ...
    */
    public enum DeleteImportJob {

        public static let service = APIService<Response>(id: "deleteImportJob", tag: "importJob", method: "DELETE", path: "/importJob/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteImportJob.service)
            }
