...
extension TMF620.ImportJob {
    ...
    */
    public enum ListImportJob {

        public static let service = APIService<Response>(id: "listImportJob", tag: "importJob", method: "GET", path: "/importJob", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ListImportJob.service)
            }
