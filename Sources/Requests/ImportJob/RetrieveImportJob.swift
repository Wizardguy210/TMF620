...
extension TMF620.ImportJob {
    ...
    */
    public enum RetrieveImportJob {

        public static let service = APIService<Response>(id: "retrieveImportJob", tag: "importJob", method: "GET", path: "/importJob/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RetrieveImportJob.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ImportJob.self, from: data))
