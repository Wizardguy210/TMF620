...
extension TMF620.Category {
    ...
    */
    public enum PatchCategory {
        ...
        public static let service = APIService<Response>(id: "patchCategory", tag: "category", method: "PATCH", path: "/category/{id}", hasBody: true, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PatchCategory.service)
            }
