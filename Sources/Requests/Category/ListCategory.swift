...
extension TMF620.Category {
    ...
    */
    public enum ListCategory {
        ...
        public static let service = APIService<Response>(id: "listCategory", tag: "category", method: "GET", path: "/category", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ListCategory.service)
            }
