...
extension TMF620.Category {
    ...
    */
    public enum RetrieveCategory {

        public static let service = APIService<Response>(id: "retrieveCategory", tag: "category", method: "GET", path: "/category/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RetrieveCategory.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = Category

            /** Success */
            case status200(Category)
            ...
            public var responseResult: APIResponseResult<Category, ErrorType> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(Category.self, from: data))
