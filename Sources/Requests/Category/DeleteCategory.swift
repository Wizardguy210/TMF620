...
extension TMF620.Category {
    ...
    */
    public enum DeleteCategory {
        ...
        public static let service = APIService<Response>(id: "deleteCategory", tag: "category", method: "DELETE", path: "/category/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteCategory.service)
            }
