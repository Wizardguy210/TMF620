...
extension TMF620.Category {
    ...
    */
    public enum CreateCategory {
        ...
        public static let service = APIService<Response>(id: "createCategory", tag: "category", method: "POST", path: "/category", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: CreateCategory.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(Category.self, from: data))
