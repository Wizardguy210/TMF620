...
extension TMF620.ProductSpecification {
    ...
    */
    public enum CreateProductSpecification {

        public static let service = APIService<Response>(id: "createProductSpecification", tag: "productSpecification", method: "POST", path: "/productSpecification", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: CreateProductSpecification.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Created */
            case status201(ProductSpecification)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ProductSpecification.self, from: data))
