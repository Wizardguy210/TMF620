...
extension TMF620.ProductSpecification {
    ...
    */
    public enum PatchProductSpecification {

        public static let service = APIService<Response>(id: "patchProductSpecification", tag: "productSpecification", method: "PATCH", path: "/productSpecification/{id}", hasBody: true, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PatchProductSpecification.service)
            }
