...
extension TMF620.ProductSpecification {
    ...
    */
    public enum DeleteProductSpecification {

        public static let service = APIService<Response>(id: "deleteProductSpecification", tag: "productSpecification", method: "DELETE", path: "/productSpecification/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteProductSpecification.service)
            }
