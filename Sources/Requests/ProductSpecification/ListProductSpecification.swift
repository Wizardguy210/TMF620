...
extension TMF620.ProductSpecification {
    ...
    */
    public enum ListProductSpecification {

        public static let service = APIService<Response>(id: "listProductSpecification", tag: "productSpecification", method: "GET", path: "/productSpecification", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ListProductSpecification.service)
            }
