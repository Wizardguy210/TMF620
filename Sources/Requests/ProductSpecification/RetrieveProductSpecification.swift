...
extension TMF620.ProductSpecification {
    ...
    */
    public enum RetrieveProductSpecification {

        public static let service = APIService<Response>(id: "retrieveProductSpecification", tag: "productSpecification", method: "GET", path: "/productSpecification/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RetrieveProductSpecification.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ProductSpecification

            /** Success */
            case status200(ProductSpecification)
            ...
            public var success: ProductSpecification? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ProductSpecification, ErrorType> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ProductSpecification.self, from: data))
