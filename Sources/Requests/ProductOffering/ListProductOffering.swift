...
extension TMF620.ProductOffering {
    ...
    */
    public enum ListProductOffering {

        public static let service = APIService<Response>(id: "listProductOffering", tag: "productOffering", method: "GET", path: "/productOffering", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ListProductOffering.service)
            }
