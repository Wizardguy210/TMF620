...
extension TMF620.ProductOffering {
    ...
    */
    public enum PatchProductOffering {

        public static let service = APIService<Response>(id: "patchProductOffering", tag: "productOffering", method: "PATCH", path: "/productOffering/{id}", hasBody: true, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PatchProductOffering.service)
            }
