...
extension TMF620.ProductOffering {
    ...
    */
    public enum RetrieveProductOffering {

        public static let service = APIService<Response>(id: "retrieveProductOffering", tag: "productOffering", method: "GET", path: "/productOffering/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RetrieveProductOffering.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ProductOffering

            /** Success */
            case status200(ProductOffering)
            ...
            public var success: ProductOffering? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ProductOffering, ErrorType> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ProductOffering.self, from: data))
