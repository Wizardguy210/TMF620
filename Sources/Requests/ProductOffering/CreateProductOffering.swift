...
extension TMF620.ProductOffering {
    ...
    */
    public enum CreateProductOffering {

        public static let service = APIService<Response>(id: "createProductOffering", tag: "productOffering", method: "POST", path: "/productOffering", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: CreateProductOffering.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Created */
            case status201(ProductOffering)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ProductOffering.self, from: data))
