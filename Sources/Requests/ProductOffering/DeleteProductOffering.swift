...
extension TMF620.ProductOffering {
    ...
    */
    public enum DeleteProductOffering {

        public static let service = APIService<Response>(id: "deleteProductOffering", tag: "productOffering", method: "DELETE", path: "/productOffering/{id}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteProductOffering.service)
            }
