...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToCatalogAttributeValueChangeEvent {

        public static let service = APIService<Response>(id: "listenToCatalogAttributeValueChangeEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/catalogAttributeValueChangeEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToCatalogAttributeValueChangeEvent.service)
            }
        }
