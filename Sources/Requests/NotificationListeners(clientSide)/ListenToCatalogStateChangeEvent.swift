...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToCatalogStateChangeEvent {

        public static let service = APIService<Response>(id: "listenToCatalogStateChangeEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/catalogStateChangeEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToCatalogStateChangeEvent.service)
            }
        }
