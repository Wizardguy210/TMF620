...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductOfferingPriceAttributeValueChangeEvent {

        public static let service = APIService<Response>(id: "listenToProductOfferingPriceAttributeValueChangeEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productOfferingPriceAttributeValueChangeEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductOfferingPriceAttributeValueChangeEvent.service)
            }
        }
