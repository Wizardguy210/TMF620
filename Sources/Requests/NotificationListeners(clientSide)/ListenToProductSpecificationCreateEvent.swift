...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductSpecificationCreateEvent {

        public static let service = APIService<Response>(id: "listenToProductSpecificationCreateEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productSpecificationCreateEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductSpecificationCreateEvent.service)
            }
        }
