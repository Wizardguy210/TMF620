...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToCatalogDeleteEvent {

        public static let service = APIService<Response>(id: "listenToCatalogDeleteEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/catalogDeleteEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToCatalogDeleteEvent.service)
            }
        }
