...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductOfferingCreateEvent {

        public static let service = APIService<Response>(id: "listenToProductOfferingCreateEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productOfferingCreateEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductOfferingCreateEvent.service)
            }
        }
