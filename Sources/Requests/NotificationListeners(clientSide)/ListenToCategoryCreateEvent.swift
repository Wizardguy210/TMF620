...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToCategoryCreateEvent {

        public static let service = APIService<Response>(id: "listenToCategoryCreateEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/categoryCreateEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToCategoryCreateEvent.service)
            }
        }
