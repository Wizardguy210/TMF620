...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToCatalogCreateEvent {

        public static let service = APIService<Response>(id: "listenToCatalogCreateEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/catalogCreateEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToCatalogCreateEvent.service)
            }
        }
