...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductOfferingDeleteEvent {

        public static let service = APIService<Response>(id: "listenToProductOfferingDeleteEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productOfferingDeleteEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductOfferingDeleteEvent.service)
            }
        }
