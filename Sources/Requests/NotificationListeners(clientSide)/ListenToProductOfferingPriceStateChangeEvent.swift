...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductOfferingPriceStateChangeEvent {

        public static let service = APIService<Response>(id: "listenToProductOfferingPriceStateChangeEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productOfferingPriceStateChangeEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductOfferingPriceStateChangeEvent.service)
            }
        }
