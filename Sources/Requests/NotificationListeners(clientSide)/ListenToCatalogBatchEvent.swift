...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToCatalogBatchEvent {

        public static let service = APIService<Response>(id: "listenToCatalogBatchEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/catalogBatchEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToCatalogBatchEvent.service)
            }
        }
