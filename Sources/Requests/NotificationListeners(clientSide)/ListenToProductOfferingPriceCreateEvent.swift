...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductOfferingPriceCreateEvent {

        public static let service = APIService<Response>(id: "listenToProductOfferingPriceCreateEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productOfferingPriceCreateEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductOfferingPriceCreateEvent.service)
            }
        }
