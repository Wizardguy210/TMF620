...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductOfferingAttributeValueChangeEvent {

        public static let service = APIService<Response>(id: "listenToProductOfferingAttributeValueChangeEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productOfferingAttributeValueChangeEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductOfferingAttributeValueChangeEvent.service)
            }
        }
