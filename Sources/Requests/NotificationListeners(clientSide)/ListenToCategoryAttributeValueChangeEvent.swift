...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToCategoryAttributeValueChangeEvent {

        public static let service = APIService<Response>(id: "listenToCategoryAttributeValueChangeEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/categoryAttributeValueChangeEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToCategoryAttributeValueChangeEvent.service)
            }
        }
