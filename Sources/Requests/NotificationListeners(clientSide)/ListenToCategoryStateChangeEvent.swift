...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToCategoryStateChangeEvent {

        public static let service = APIService<Response>(id: "listenToCategoryStateChangeEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/categoryStateChangeEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToCategoryStateChangeEvent.service)
            }
        }
