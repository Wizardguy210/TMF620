...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductOfferingPriceDeleteEvent {

        public static let service = APIService<Response>(id: "listenToProductOfferingPriceDeleteEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productOfferingPriceDeleteEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductOfferingPriceDeleteEvent.service)
            }
        }
