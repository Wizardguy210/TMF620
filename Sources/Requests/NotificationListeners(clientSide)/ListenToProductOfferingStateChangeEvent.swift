...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductOfferingStateChangeEvent {

        public static let service = APIService<Response>(id: "listenToProductOfferingStateChangeEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productOfferingStateChangeEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductOfferingStateChangeEvent.service)
            }
        }
