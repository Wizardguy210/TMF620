...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductSpecificationAttributeValueChangeEvent {

        public static let service = APIService<Response>(id: "listenToProductSpecificationAttributeValueChangeEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productSpecificationAttributeValueChangeEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductSpecificationAttributeValueChangeEvent.service)
            }
        }
