...
extension TMF620.NotificationListeners {
    ...
    */
    public enum ListenToProductSpecificationDeleteEvent {

        public static let service = APIService<Response>(id: "listenToProductSpecificationDeleteEvent", tag: "notification listeners (client side)", method: "POST", path: "/listener/productSpecificationDeleteEvent", hasBody: true, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ListenToProductSpecificationDeleteEvent.service)
            }
        }
